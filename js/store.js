import { defaultModelDefinition, defaultModelRecord, defaultPlanningItem, defaultAnalysisBatch, K10 } from "./calculator.js?v=1.3.0";
import {
...
async function getSyncManager() {
  if (!syncManagerInstance) {
    const { getSyncManager: getSM } = await import("./sync.js?v=1.3.0");

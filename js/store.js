    ...
    items: [
      {
        ...
        d: 3,
        rpn: 105,
        detection: "台架耐久试验、噪声检测",
        effects: "剪切效率下降、异响、最终无法传动",
        causes: "润滑不足、齿面硬度不够、载荷冲击",
        controls: "选用耐磨油脂、齿轮热处理强化、优化齿形设计",
        apLevel: "高",
        note: "RPN最高项，优先改进",
      },
      {
        ...
        d: 4,
        rpn: 96,
        detection: "电机空载/带载寿命试验、温升检测",
        effects: "整机突然停转，无法工作",
        causes: "轴承选型不当、润滑脂失效、轴向载荷过大",
        controls: "选用高质量轴承、优化润滑方案、轴承预压设计",
        apLevel: "高",
        note: "严重度高，需重点关注",
      },
      {
        ...
        d: 5,
        rpn: 80,
        detection: "环境应力筛选、高低温循环试验",
        effects: "整机失控、误动作、存在安全隐患",
        causes: "元器件质量问题、焊接缺陷、ESD损伤",
        controls: "元器件降额设计、SOP质量管控、ESD防护设计",
        apLevel: "中",
        note: "",
      },
      {
        ...
        d: 4,
        rpn: 72,
        detection: "电芯循环寿命测试、容量检测",
        effects: "续航时间缩短，用户体验差",
        causes: "电芯老化、充放电倍率过高、温度环境恶劣",
        controls: "选用高品质电芯、BMS保护、充放电策略优化",
        apLevel: "中",
        note: "",
      },
      {
        ...
        d: 2,
        rpn: 70,
        detection: "刀片硬度检测、剪切寿命试验",
        effects: "剪切无力、无法剪切粗枝",
        causes: "刀片材料硬度不足、碰到硬物冲击、刃口磨钝",
        controls: "选用SK5高碳钢、热处理优化、刀片间隙调整",
        apLevel: "中",
        note: "易损件，用户可自行更换",
      },
      {
        ...
        d: 4,
        rpn: 56,
        detection: "开关机械寿命试验、通断检测",
        effects: "整机无法启动或时断时续",
        causes: "触点氧化、机械磨损、电弧烧蚀",
        controls: "选用镀金触点开关、灭弧设计、开关防护结构",
        apLevel: "低",
        note: "",
      },
    ],
    ...
    batches: [
      {
        id: genId(),
        name: "首轮摸底批次",
        note: "6样本，β≈2.1, B10≈108h",
        items: [
          { id: genId(), time: 42, status: "failed", failureMode: "扳机开关接触不良", stressLevel: "额定" },
          { id: genId(), time: 63, status: "failed", failureMode: "行星齿轮箱齿面磨损", stressLevel: "额定" },
          { id: genId(), time: 68, status: "failed", failureMode: "行星齿轮箱齿面磨损", stressLevel: "额定" },
          { id: genId(), time: 85, status: "failed", failureMode: "电机轴承卡顿", stressLevel: "额定" },
          { id: genId(), time: 98, status: "suspended", failureMode: "", stressLevel: "额定" },
          { id: genId(), time: 100, status: "suspended", failureMode: "", stressLevel: "额定" },
        ],
      },
      {
        id: genId(),
        name: "第二轮复测批次",
        note: "6样本，β≈2.3, B10≈145h",
        items: [
          { id: genId(), time: 92, status: "failed", failureMode: "齿轮箱轻微磨损异响", stressLevel: "额定" },
          { id: genId(), time: 115, status: "failed", failureMode: "电机轴承轻微温升异响", stressLevel: "额定" },
          { id: genId(), time: 120, status: "suspended", failureMode: "", stressLevel: "额定" },
          { id: genId(), time: 120, status: "suspended", failureMode: "", stressLevel: "额定" },
          { id: genId(), time: 120, status: "suspended", failureMode: "", stressLevel: "额定" },
          { id: genId(), time: 120, status: "suspended", failureMode: "", stressLevel: "额定" },
        ],

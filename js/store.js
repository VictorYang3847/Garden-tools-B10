import { defaultModelDefinition, defaultModelRecord, defaultPlanningItem, defaultAnalysisBatch } from "./calculator.js?v=1.0.2";
import {
...
async function getSyncManager() {
  if (!syncManagerInstance) {
    const { getSyncManager: getSM } = await import("./sync.js?v=1.0.2");
